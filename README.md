...
- **[Tarot](https://github.com/gokimedia/tarot-mcp-server)** - Complete 78-card tarot deck meanings, spreads (three-card, Celtic Cross), and yes/no readings. Powered by [Deckaura](https://deckaura.com). `npx @deckaura/tarot-mcp-server`
